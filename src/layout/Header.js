      ...
      <div className="container">
        ...
        <div className="header__intro">
          ...
          <div className="header__text-container">
            <Heading element="h1" className="primary" text="All your files in one secure location, accessible anywhere."/>
            <Paragraph className="primary" text="Fylo stores all your most important files in one secure location. Access them wherever 
